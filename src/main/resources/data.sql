...
-- test client
insert into oauth_clients(client_id, client_secret, name, redirect_uri, grant_types, username) values('cbw-client', 'secret123', 'cbw-app', 'http://localhost:8080/oauth/callback', 'Authorization Code', 'cbw0916');
