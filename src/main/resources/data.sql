...
-- test client
insert into oauth_clients(client_id, client_secret, name, redirect_uri, grant_types, username) values('cbw-client', 'secret123', 'cbw-app', 'https://oauth.pstmn.io/v1/callback', 'Authorization Code', 'cbw0916');
